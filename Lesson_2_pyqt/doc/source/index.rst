...
Приложение обеспечивает зашифрованную передачу текстовых сообщений между клиентами. Состоит из 2-х частей: сервер и клиент.
...
Сервер и клиенты используют собственные базы данных sqllite. Пароли от логинов на стороне сервера хранятся в зашифрованном хэшированном виде.
