...
from Lesson_2_pyqt.lib.descriptors import PortValidate
from Lesson_2_pyqt.lib.metaclasses import ServerMaker
from Lesson_2_pyqt.server_db import ServerStorage
from Lesson_2_pyqt.server_gui import MainWindow, gui_create_model, HistoryWindow, create_stat_model, ConfigWindow,\
...
class Server(threading.Thread, metaclass=ServerMaker):
    ...
    def init_socket(self):
        server_logger.info(f'Сервер запущен. Порт для подключений: {self.port}.'
...
def start_server():
    ...
    # история коннектов пользователей
    ...
    # Связываем элементов управления и процедур
